...
function oneCard(props, index) {
  return (
    <div className="oneCard">
      ...
      />
      <div className="nameTitleOneCard">{props[index].title}</div>
      <div className="descriptionOneCard">{props[index].description}</div>
...
function cardSeries(props, data, index_1, index_2, index_3) {
  ...
  if (data.length - 1 < index_1) {
    return <div className="cardSeries"></div>;
  }
  ...
  //Không có dữ liệu hiển thị cho card_2 và card_3
    ...
    return (
      <div className="cardSeries">
        <div className="series-1">{props(data, index_1)}</div>
      </div>
    );
  }
  ...
  //Không có dữ liệu hiển thị cho card_3
    ...
    return (
      <div className="cardSeries">
        <div className="series-1">{props(data, index_1)}</div>
        <div className="series-2">{props(data, index_2)}</div>
      </div>
    );
  }
  ...
  //Hiển thị đầy đủ 3 card
    ...
    return (
      <div className="cardSeries">
        <div className="series-1">{props(data, index_1)}</div>
        <div className="series-2">{props(data, index_2)}</div>
        <div className="series-3">{props(data, index_3)}</div>
      </div>
    );
  }
}
...
function ClipList1() {
  return (
    <div className="cliplist1">
      <FixedButton />
      <div className="slide-1">{titleSeries(infoTitle[0])}</div>
      <div className="slide-2">{cardSeries(oneCard, categories, 0, 1, 2)}</div>
      <div className="slide-3">{titleSeries(infoTitle[1])}</div>
      <div className="slide-4">{cardSeries(oneCard, categories, 3, 4, 5)}</div>
      <BottomInfo />
    </div>
  );
}
